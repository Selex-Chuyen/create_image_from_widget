...
class _MapScreenCaptureState extends State<MapScreenCapture> {
  ...
  Timer? _timer;
  int _captureIntervalInSeconds = 10; // Khoảng thời gian giữa các lần chụp (60 giây trong ví dụ này)
  ...
  try {
    ...
    if (globalKey.currentContext != null) {
      ...
      if (renderObject is RenderRepaintBoundary) {
        ...
        print("Không thể chụp ảnh màn hình: renderObject không phải là RenderRepaintBoundary");
      }
    } else {
